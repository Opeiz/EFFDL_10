...
parser.add_argument('--fact_level', default=0, type=float, help='Level of factorization [0,1,2]')
...
from model_cifar100 import preact_resnet_factorized
...
net = preact_resnet_factorized.PreActResNet18(args.fact_level)
net = net.to(device)
